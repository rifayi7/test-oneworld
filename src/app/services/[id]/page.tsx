...
const FAQS_BY_CATEGORY: Record<string, { q: string; a: string }[]> = {
  "Water Services": [
    { q: "How long does a typical well/tank cleaning take?", a: "Most residential tanks take 2–3 hours. Deep wells may take 4–6 hours depending on the depth, silt buildup, and ease of access." },
    { q: "Do you use chemicals that make water unsafe?", a: "No. We use chemical-free, food-grade disinfection agents and high-pressure steam/jets. The water is thoroughly flushed and tested before we sign off." },
    { q: "How often should I clean my water tank?", a: "Health authorities recommend cleaning domestic water storage tanks at least once every 6 months to prevent bacterial growth and silt buildup." }
  ],
  "Home Safety": [
    { q: "Will the CCTV cameras record if the power goes out?", a: "If connected to a home UPS or inverter, they will record. We can also configure cameras with built-in battery backups or configure solar-powered setups." },
    { q: "Is the solar panel installation eligible for government subsidy?", a: "Yes, we handle all grid registration and subsidy paperwork for eligible domestic connections to save you the hassle." },
    { q: "Can I monitor the security cameras on multiple phones?", a: "Yes. During installation, we will set up the primary account and share access to family members' devices securely." }
  ],
  "Outdoor Services": [
    { q: "Do you clear and dispose of the cut grass?", a: "Yes, our team bags all cut grass, weeds, and garden trimmings and disposes of them off-site as part of the service." },
    { q: "Do you supply the interlock cleaning chemicals?", a: "Yes, we bring all high-pressure jet wash equipment and specialized eco-safe tile cleaners to remove mold and moss without damaging the paved tiles." },
    { q: "Can you trim grass during heavy rain?", a: "Light rain is fine, but for safety reasons and to avoid damaging your lawn's soil, we may reschedule in case of heavy downpours." }
  ],
  "Pest Control": [
    { q: "Are the pesticides safe for pets and children?", a: "Yes. We use advanced, low-toxicity green products that are targeted at pests. We will provide simple safety precautions for children and pets during application." },
    { q: "How long do I need to stay out of the house?", a: "For standard spraying, you can remain home or step out for just 1-2 hours. For intensive termite control, we'll advise based on the area size." },
    { q: "Do you offer a warranty on pest control?", a: "Yes, our termite and general pest control services come with a written warranty. If pests return during that period, we re-treat at zero cost." }
  ],
  "Farm Services": [
    { q: "What tools do you use for coconut plucking?", a: "We use professional mechanical tree climbers and safety harness rigs, ensuring the pluckers' safety and protecting the tree's bark." },
    { q: "Do you provide fertilizer along with basin making?", a: "We can provide organic manures and fertilizers on request, or feed fertilizers that you have already purchased during the bunding process." },
    { q: "Do you clean the farm area after the work is done?", a: "Yes. We gather harvested crops in a designated location and clear dry fronds or tree trimmings away from pathways." }
  ]
};

const DEFAULT_FAQS = [
  { q: "How do I pay for the service?", a: "You pay after the service is fully completed. We accept UPI, bank transfers, and cash directly." },
  { q: "Can I reschedule or cancel my booking?", a: "Yes, you can reschedule or cancel at any time up to 12 hours before the appointment at no charge." },
  { q: "Are your service partners background-verified?", a: "Absolutely. All professionals undergo strict criminal background checks and identity verification prior to onboarding." }
];
...
export default async function ServiceDetailPage({ params }: PageProps) {
  ...
  if (related.length < 3) {
    ...
    const extraServices = allServices.filter((s) => !idsToExclude.includes(s.id));
        ...
        <div className="container mx-auto max-w-7xl px-6 lg:px-12">
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 mb-8">
            ...
            <div className="flex items-center gap-1.5 text-xs text-slate-400 font-semibold select-none">
              ...
              <ChevronRight className="w-3.5 h-3.5" />
              <span className="text-slate-600 font-bold truncate max-w-[200px]">{service.name}</span>
            </div>
          </div>
                ...
                >
                  ...
                  <div className="p-5 flex-grow flex flex-col justify-between space-y-3">
                    ...
                    <div className="text-xs font-bold text-primary-600 flex items-center gap-1 group-hover:gap-1.5 transition-all pt-1">
                      Explore Details <ChevronRight className="w-3.5 h-3.5 stroke-[2.5]" />
                    </div>
                  </div>
                </Link>
              ))}
